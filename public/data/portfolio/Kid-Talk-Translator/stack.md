...
| `@vercel/kv` | Server-side key-value cache for API responses and rate-limit counters |
...
| `@firebase/rules-unit-testing` | Firestore rules tests against the Firebase emulator |
| `firebase-tools` | Local Firestore emulator runner for rules tests |
| `jsdom` | DOM implementation for component tests in Node |
