...
Install with npm: `npm install -g vercel` — or see [vercel.com/docs/cli](https://vercel.com/docs/cli)
...
Install with npm (after Node.js is installed): `npm install -g vercel`
...
Once you have Node.js installed, installing Claude Code is one command:

```bash
npm install -g @anthropic-ai/claude-code
```

The `-g` means "install globally" so you can use it from anywhere on your computer. Run `claude --version` to verify it's installed.
