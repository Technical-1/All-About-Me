...
```
Create a new React application using TanStack Router and TanStack Start.
Use pnpm as the package manager. Set it up with TypeScript and Tailwind CSS.
